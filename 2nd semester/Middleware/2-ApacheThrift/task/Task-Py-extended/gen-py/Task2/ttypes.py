...
class ItemB(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ItemB')
        if self.fieldX is not None:
            oprot.writeFieldBegin('fieldX', TType.I16, 1)
            oprot.writeI16(self.fieldX)
            oprot.writeFieldEnd()
        if self.fieldY is not None:
            oprot.writeFieldBegin('fieldY', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.fieldY))
            for iter19 in self.fieldY:
                oprot.writeString(iter19.encode('utf-8') if sys.version_info[0] == 2 else iter19)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.fieldZ is not None:
            oprot.writeFieldBegin('fieldZ', TType.SET, 3)
            oprot.writeSetBegin(TType.STRING, len(self.fieldZ))
            for iter20 in self.fieldZ:
    ...
    def validate(self):
        if self.fieldX is None:
            raise TProtocolException(message='Required field fieldX is unset!')
        if self.fieldZ is None:
            raise TProtocolException(message='Required field fieldZ is unset!')
        return
...
class ItemC(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ItemC')
        if self.fieldX is not None:
            oprot.writeFieldBegin('fieldX', TType.BOOL, 1)
            oprot.writeBool(self.fieldX)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class Item(object):
    ...
    def __init__(self, itemA=None, itemB=None, itemC=None, type=None,):
        self.itemA = itemA
        self.itemB = itemB
        self.itemC = itemC
        self.type = type
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.itemA = ItemA()
                    self.itemA.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.itemB = ItemB()
                    self.itemB.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRUCT:
                    self.itemC = ItemC()
                    self.itemC.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.itemA is not None:
            oprot.writeFieldBegin('itemA', TType.STRUCT, 1)
            self.itemA.write(oprot)
            oprot.writeFieldEnd()
        if self.itemB is not None:
            oprot.writeFieldBegin('itemB', TType.STRUCT, 2)
            self.itemB.write(oprot)
            oprot.writeFieldEnd()
        if self.itemC is not None:
            oprot.writeFieldBegin('itemC', TType.STRUCT, 3)
            self.itemC.write(oprot)
            oprot.writeFieldEnd()
...
class FetchMultipleResult(object):
    """
    Attributes:
     - status
     - items
    ...
    def __init__(self, status=None, items=None,):
        self.status = status
        self.items = items
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('FetchMultipleResult')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.I32, 1)
            oprot.writeI32(self.status)
            oprot.writeFieldEnd()
...
all_structs.append(ItemB)
ItemB.thrift_spec = (
    None,  # 0
    (1, TType.I16, 'fieldX', None, None, ),  # 1
    (2, TType.LIST, 'fieldY', (TType.STRING, 'UTF8', False), None, ),  # 2
    (3, TType.SET, 'fieldZ', (TType.STRING, 'UTF8', False), None, ),  # 3
)
all_structs.append(ItemC)
ItemC.thrift_spec = (
    None,  # 0
    (1, TType.BOOL, 'fieldX', None, None, ),  # 1
)
all_structs.append(Item)
Item.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'itemA', [ItemA, None], None, ),  # 1
    (2, TType.STRUCT, 'itemB', [ItemB, None], None, ),  # 2
    (3, TType.STRUCT, 'itemC', [ItemC, None], None, ),  # 3
...
all_structs.append(FetchMultipleResult)
FetchMultipleResult.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'status', None, None, ),  # 1
