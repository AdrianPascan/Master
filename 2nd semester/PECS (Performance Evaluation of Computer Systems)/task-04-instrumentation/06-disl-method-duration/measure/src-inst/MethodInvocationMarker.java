...
public class MethodInvocationMarker extends AbstractDWRMarker {
	...
	public List<MarkedRegion> markWithDefaultWeavingReg(MethodNode method) {
		...
		for (AbstractInsnNode instruction : instructions.toArray()) {
			// check for method invocation instructions, skip "System.currentTimeMillis" method invocation
			if (instruction instanceof MethodInsnNode && !((MethodInsnNode) instruction).name.equals("currentTimeMillis")) {
